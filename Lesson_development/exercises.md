...
2. Pair up:
   ...
   * Clone or fork each other’s repositories. (Instructor can decide which teams clone and which fork, then we should compare the two approaches and discuss the pros and cons of each.)
